 ...
 */
@RestController
public class InsertYesterdayStatisticsScheduleTask {
     ...
     * @return
     */
    @RequestMapping("/insertYesterdayStatistics/startTask")
    public ResultUtil<Boolean> startTask() {
        /**
         * task:定时任务要执行的方法
         * trigger:定时任务执行的时间
         */
        schedulingTask = schedulingTaskDao.queryById(Integer.valueOf(ScheduleTaskEnum.INSERT_YESTERDAY_STATISTICS.getCode()));
     ...
     * @return
     */
    @RequestMapping("/insertYesterdayStatistics/endTask")
     ...
     * 2,在启动定时器
     */
    @RequestMapping("/insertYesterdayStatistics/changeTask")
    ...
    @RequestMapping("/insertYesterdayStatistics/executeOnce")
