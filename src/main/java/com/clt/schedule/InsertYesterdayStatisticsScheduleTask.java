...
public class InsertYesterdayStatisticsScheduleTask {
     ...
     * @return
     */
    @GetMapping("/insertYesterdayStatistics/startTask")
    public ResultUtil<Boolean> startTask() {
        /**
         * task:定时任务要执行的方法
         * trigger:定时任务执行的时间
         */
        SchedulingTask schedulingTask = schedulingTaskDao.queryById(Integer.valueOf(ScheduleTaskEnum.INSERT_YESTERDAY_STATISTICS.getCode()));
     ...
     * @return
     */
    @GetMapping("/insertYesterdayStatistics/endTask")
     ...
     * 2,在启动定时器
     */
    @GetMapping("/insertYesterdayStatistics/changeTask")
    ...
    @GetMapping("/insertYesterdayStatistics/executeOnce")
